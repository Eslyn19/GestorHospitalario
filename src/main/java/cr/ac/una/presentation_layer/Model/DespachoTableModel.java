...
public class DespachoTableModel extends AbstractTableModel implements IServiceObserver<Receta> {
    private final String[] cols = {"ID", "Paciente", "Médico", "Fecha Confección", "Estado"};
    ...
    @Override public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 4: return receta.getEstado();
            default: return null;
        }
    }
